...
use anyhow::Result;
use milevadb_query_datatype::codec::datum_codec::DatumFlagAndPayloadEncoder;
...
pub fn fuzz_codec_bytes(data: &[u8]) -> Result<()> {
    let _ = einsteindb_util::codec::bytes::encode_bytes(data);
    let _ = einsteindb_util::codec::bytes::encode_bytes_desc(data);
    let _ = einsteindb_util::codec::bytes::encoded_bytes_len(data, true);
    let _ = einsteindb_util::codec::bytes::encoded_bytes_len(data, false);
    Ok(())
}
...
pub fn fuzz_codec_number(data: &[u8]) -> Result<()> {
    ...
    }
    {
        ...
        let _ = einsteindb_util::codec::number::decode_u64(&mut buf.as_slice());
        let _ = einsteindb_util::codec::number::decode_u64_desc(&mut buf.as_slice());
        let _ = einsteindb_util::codec::number::decode_u64_le(&mut buf.as_slice());
        let _ = einsteindb_util::codec::number::decode_i64(&mut buf.as_slice());
        let _ = einsteindb_util::codec::number::decode_i64_desc(&mut buf.as_slice());
        let _ = einsteindb_util::codec::number::decode_i64_le(&mut buf.as_slice());
        let _ = einsteindb_util::codec::number::decode_f64(&mut buf.as_slice());
        let _ = einsteindb_util::codec::number::decode_f64_desc(&mut buf.as_slice());
        let _ = einsteindb_util::codec::number::decode_f64_le(&mut buf.as_slice());
        let _ = einsteindb_util::codec::number::decode_u32(&mut buf.as_slice());
        let _ = einsteindb_util::codec::number::decode_u32_le(&mut buf.as_slice());
        let _ = einsteindb_util::codec::number::decode_i32_le(&mut buf.as_slice());
        let _ = einsteindb_util::codec::number::decode_u16(&mut buf.as_slice());
        let _ = einsteindb_util::codec::number::decode_u16_le(&mut buf.as_slice());
    }
    Ok(())
}
...
trait ReadAsDecimalRoundMode: ReadLiteralExt {
    fn read_as_decimal_round_mode(
        &mut self,
    ) -> Result<::milevadb_query_datatype::codec::mysql::decimal::RoundMode> {
        Ok(match self.read_as_u8()? % 3 {
            0 => milevadb_query_datatype::codec::mysql::decimal::RoundMode::HalfEven,
            1 => milevadb_query_datatype::codec::mysql::decimal::RoundMode::Truncate,
            _ => milevadb_query_datatype::codec::mysql::decimal::RoundMode::Ceiling,
        })
    }
}
...
#[inline(always)]
pub fn fuzz_interlock_codec_decimal(data: &[u8]) -> Result<()> {
...
trait ReadAsTimeType: ReadLiteralExt {
    fn read_as_time_type(&mut self) -> Result<::milevadb_query_datatype::codec::mysql::TimeType> {
        Ok(match self.read_as_u8()? % 3 {
            0 => milevadb_query_datatype::codec::mysql::TimeType::Date,
            1 => milevadb_query_datatype::codec::mysql::TimeType::DateTime,
            _ => milevadb_query_datatype::codec::mysql::TimeType::Timestamp,
        })
    }
}
...
fn fuzz_time(t: milevadb_query_datatype::codec::mysql::Time, mut cursor: Cursor<&[u8]>) -> Result<()> {
    use milevadb_query_datatype::codec::convert::ConvertTo;
    use milevadb_query_datatype::codec::data_type::{Decimal, Duration};
    use milevadb_query_datatype::codec::mysql::TimeEncoder;
...
pub fn fuzz_interlock_codec_time_from_parse(data: &[u8]) -> Result<()> {
    use std::io::Read;
    use milevadb_query_datatype::codec::mysql::{Time, Tz};
...
pub fn fuzz_interlock_codec_time_from_u64(data: &[u8]) -> Result<()> {
    use milevadb_query_datatype::codec::mysql::{Time, Tz};
...
// Duration
fn fuzz_duration(
    t: milevadb_query_datatype::codec::mysql::Duration,
...
pub fn fuzz_interlock_codec_duration_from_nanos(data: &[u8]) -> Result<()> {
...
pub fn fuzz_interlock_codec_duration_from_parse(data: &[u8]) -> Result<()> {
    use std::io::Read;
    use milevadb_query_datatype::codec::mysql::Duration;
...
pub fn fuzz_interlock_codec_row_v2_binary_search(data: &[u8]) -> Result<()> {
    use milevadb_query_datatype::codec::row::v2::RowSlice;
