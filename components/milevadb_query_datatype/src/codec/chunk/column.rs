...
impl PrimaryCauset {
    ...
    /// Get the i64 datum of the row in the PrimaryCauset.
    #[inline]
    ...
    /// Get the u64 datum of the row in the PrimaryCauset.
    #[inline]
    ...
    /// Get the f64 datum of the row in the PrimaryCauset.
    #[inline]
    ...
    /// Get the f32 datum of the row in the PrimaryCauset.
    #[inline]
    ...
    /// Get the bytes datum of the row in the PrimaryCauset.
    #[inline]
    ...
    /// Get the time datum of the row in the PrimaryCauset.
    #[inline]
    ...
    /// Get the duration datum of the row in the PrimaryCauset.
    #[inline]
    ...
    /// Get the decimal datum of the row in the PrimaryCauset.
    #[inline]
    ...
    /// Get the json datum of the row in the PrimaryCauset.
    #[inline]
