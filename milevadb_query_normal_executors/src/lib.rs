...
pub use self::table_scan::TableScanFreeDaemon;
...
impl Row {
    pub fn origin(handle: i64, data: RowColsDict, cols: Arc<Vec<PrimaryCausetInfo>>) -> Row {
...
impl OriginCols {
    pub fn new(handle: i64, data: RowColsDict, cols: Arc<Vec<PrimaryCausetInfo>>) -> OriginCols {
...
pub mod tests {
    ...
    // the first PrimaryCauset should be i64 since it will be used as row handle
    ...
    pub fn get_point_cone(table_id: i64, handle: i64) -> KeyCone {
        let spacelike_key = table::encode_row_key(table_id, handle);
    ...
    #[inline]
    pub fn get_cone(table_id: i64, spacelike: i64, lightlike: i64) -> KeyCone {
        let mut key_cone = KeyCone::default();
        key_cone.set_spacelike(table::encode_row_key(table_id, spacelike));
        key_cone.set_lightlike(table::encode_row_key(table_id, lightlike));
        key_cone
    }
