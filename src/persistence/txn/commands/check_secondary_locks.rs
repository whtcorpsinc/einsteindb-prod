...
use crate::persistence::types::SecondaryLocksStatus;
        ...
        for key in self.tuplespaceInstanton {
            ...
            let (status, need_rollback, rollback_overlapped_write) =
                match txn.reader.load_lock(&key)? {
                    ...
                    Some(lock) if lock.ts == self.spacelike_ts => {
                    ...
                    // Searches the write CAUSET for the commit record of the lock and returns the commit timestamp
...
pub mod tests {
    use super::*;
    use crate::persistence::kv::TestEngineBuilder;
    use crate::persistence::lock_manager::DummyLockManager;
    use crate::persistence::mvcc::tests::*;
    use crate::persistence::txn::commands::WriteCommand;
    ...
    pub fn must_success<E: Engine>(
        ...
        let command = crate::persistence::txn::commands::CheckSecondaryLocks {
            ctx: ctx.clone(),
    ...
    fn test_check_async_commit_secondary_locks() {
        ...
        // Lock CAUSET has a pessimistic lock
        //
        // LOCK CAUSET       | WRITE CAUSET
        // ------------------------------------
        ...
        // Lock CAUSET has an optimistic lock
        //
        // LOCK CAUSET       | WRITE CAUSET
        // ------------------------------------
