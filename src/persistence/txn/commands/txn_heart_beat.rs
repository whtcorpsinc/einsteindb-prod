...
use crate::persistence::mvcc::{ErrorInner as MvccErrorInner, MvccTxn, Result as MvccResult};
...
command! {
    ...
    TxnHeartBeat:
        ...
        content => {
            ...
            /// The new TTL that will be used to ufidelate the lock's TTL. If the lock's TTL is already
...
pub mod tests {
    ...
    pub fn must_success<E: Engine>(
        ...
        let command = crate::persistence::txn::commands::TxnHeartBeat {
            ctx: Context::default(),
    ...
    fn test_txn_heart_beat() {
        ...
        let test = |ts| {
            ...
            // The lock's TTL is ufidelated and persisted into the db.
