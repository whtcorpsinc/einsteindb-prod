...
impl ErrorCodeExt for Error {
    fn error_code(&self) -> ErrorCode {
        match self.0.as_ref() {
            ...
            ErrorInner::Closed => error_code::persistence::CLOSED,
            ErrorInner::Other(_) => error_code::persistence::UNKNOWN,
            ErrorInner::Io(_) => error_code::persistence::IO,
            ErrorInner::SchedTooBusy => error_code::persistence::SCHED_TOO_BUSY,
            ErrorInner::GcWorkerTooBusy => error_code::persistence::GC_WORKER_TOO_BUSY,
            ErrorInner::KeyTooLarge(_, _) => error_code::persistence::KEY_TOO_LARGE,
            ErrorInner::InvalidCf(_) => error_code::persistence::INVALID_CAUSET,
        }
    }
}
