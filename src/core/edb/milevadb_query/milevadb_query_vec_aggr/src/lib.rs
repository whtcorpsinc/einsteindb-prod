...
pub trait AggrFunction: std::fmt::Debug + lightlike + 'static {
    ...
    /// Creates a new state instance. Different states aggregate indeplightlikeently.
    ...
    ( $ty:ty ) => {
            ...
            VectorValue: VectorValueExt<T::EvaluableType>,
        {
            ...
            default unsafe fn fidelio_vector_unsafe(
                ...
                _physical_values: T1::SolitonedType,
                _logical_rows: &[usize],
            ) -> Result<()> {
                panic!("Unmatched parameter type")
            }
...
pub trait AggrFunctionStatefidelioPartial<TT: EvaluableRef<'static>> {
    ...
    unsafe fn fidelio_vector_unsafe(
        ...
        physical_values: TT::SolitonedType,
        logical_rows: &[usize],
    ) -> Result<()>;
}
    ...
    State: ConcreteAggrFunctionState,
{
    ...
    default unsafe fn fidelio_vector_unsafe(
        ...
        _physical_values: T::SolitonedType,
        _logical_rows: &[usize],
    ) -> Result<()> {
        panic!("Unmatched parameter type")
    }
    ...
    State: ConcreteAggrFunctionState<ParameterType = T>,
{
    ...
    unsafe fn fidelio_vector_unsafe(
        ...
        ctx: &mut EvalContext,
        _phantom_data: Option<T>,
        physical_values: T::SolitonedType,
        logical_rows: &[usize],
    ) -> Result<()> {
