...
fn prepare_cluster() -> Cluster<ServerCluster> {
    ...
    cluster.causetg.raft_store.fidel_store_heartbeat_tick_interval = ReadableDuration::millis(50);
...
fn test_switching_replication_mode_hibernate() {
    ...
    fidel_client.configure_dr_auto_sync("zone");
    cluster.causetg.raft_store.fidel_store_heartbeat_tick_interval = ReadableDuration::millis(50);
    cluster.causetg.raft_store.raft_log_gc_memory_barrier = 20;
    cluster.add_label(1, "zone", "ES");
    cluster.add_label(2, "zone", "ES");
    cluster.add_label(3, "zone", "WS");
    ...
    thread::sleep(
        cluster.causetg.raft_store.raft_base_tick_interval.0
            * 2
