...
fn test_serde_custom_einsteindb_config() {
    ...
    value.server = ServerConfig {
        ...
        max_grpc_slightlike_msg_len: 6 * (1 << 20),
        concurrent_slightlike_snap_limit: 4,
    ...
    value.raft_store = VioletaBftstoreConfig {
        prevote: false,
    ...
    let titan_causet_config = TitanCfConfig {
    ...
    value.raftdb = VioletaBftDbConfig {
        info_log_level: LogLevel::Info,
