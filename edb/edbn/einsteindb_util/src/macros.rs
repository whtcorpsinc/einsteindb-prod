...
///
/// ```
/// # #[macro_use] extern crate einsteindb-prod_util;
/// # fn main() {
...
/// # fn main() {
/// // empty map
/// let m: einsteindb-prod_util::collections::HashMap<u8, u8> = map!();
/// assert!(m.is_empty());
///
...
/// The final log level deplightlikes on the given `cost` and `slow_log_memory_barrier`
#[macro_export]
