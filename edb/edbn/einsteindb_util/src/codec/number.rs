...
pub trait NumberEncoder: Write {
    ...
    /// It guarantees that the encoded value is in asclightlikeing order for comparison.
    ...
    /// Writes the encoded value to buf.
    /// It guarantees that the encoded value is in desclightlikeing order for comparison.
    ...
    /// Writes the encoded value to slice buf in big lightlikeian order.
...
mod tests {
    ...
    test_serialize!(
        var_i64_little_lightlikeian_codec,
        encode_i64_le,
        decode_i64_le,
        I64_TESTS
    );
    ...
    test_serialize!(
        var_u64_little_lightlikeian_codec,
        encode_u64_le,
        decode_u64_le,
        U64_TESTS
    );
    ...
    test_serialize!(
        var_i32_little_lightlikeian_codec,
        encode_i32_le,
        decode_i32_le,
        I32_TESTS
    );
