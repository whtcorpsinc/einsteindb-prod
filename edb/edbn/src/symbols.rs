...
/// This concept is imported from Clojure, as it features in EDBN and the causetq
/// syntax that we use.
///
...
impl Display for NamespacedSymbol {
    ...
    ///
    /// ```rust
    /// # use edbn::symbols::NamespacedSymbol;
...
impl Display for Keyword {
    /// Print the keyword in EDBN format.
    ///
    /// # Examples
    ///
    /// ```rust
