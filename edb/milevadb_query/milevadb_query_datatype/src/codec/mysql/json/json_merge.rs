...
impl Json {
    ...
    ///
    /// See `MergeBinary()` in MilevaDB `json/binary_function.go`
...
// See `mergeBinaryArray()` in MilevaDB `json/binary_function.go`
...
// See `mergeBinaryObject()` in MilevaDB `json/binary_function.go`
